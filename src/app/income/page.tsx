                    ...
                    <div className="flex flex-col gap-5">
                        <div className="relative flex justify-between items-center bg-[#373737] rounded-[10px] p-4 w-full">
                            <div>
                                <div className="flex items-center gap-3">
                                    ...
                                    <h5 className="text-indigo-400 font-bold lg:text-xl sm: text-sm">Freelance</h5>
                                </div>
                                <div className="flex gap-4 mt-6">
                                    <div className="flex items-center gap-1">
                                        <FaDollarSign className="text-indigo-400 lg:text-sm sm: text-[9px]" />
                                        <h6 className="text-indigo-400 font-bold lg:text-sm sm: text-[9px]">1500,00</h6>
                                    </div>
                                    <div className="flex items-center gap-1">
                                    ...
                                    <div className="flex items-center gap-1">
                                        ...
                                        <h6 className="text-sm text-indigo-400 font-bold lg:text-sm sm: text-[9px]">Um site de blog</h6>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="relative flex justify-between items-center bg-[#373737] rounded-[10px] p-4 w-full">
                            <div>
                                <div className="flex items-center gap-3">
                                    <div className="lg:w-[20px] lg:h-[20px] rounded-full bg-lime-500 sm: w-[10px] h-[10px]"></div>
                                    <h5 className="text-indigo-400 font-bold lg:text-xl sm: text-sm">Salário</h5>
                                </div>
                                <div className="flex gap-4 mt-6">
                                    <div className="flex items-center gap-1">
                                        <FaDollarSign className="text-indigo-400 lg:text-sm sm: text-[9px]" />
                                        <h6 className="text-sm text-indigo-400 font-bold lg:text-sm sm: text-[9px]">1500,00</h6>
                                    </div>
                                    <div className="flex items-center gap-1">
                                        <FaCalendarAlt className="text-indigo-400 lg:text-sm sm: text-[9px]" />
                                        <h6 className="text-sm text-indigo-400 font-bold lg:text-sm sm: text-[9px]">12/04/2024</h6>
                                    ...
                                    <div className="flex items-center gap-1">
                                        ...
                                        <h6 className="text-sm text-indigo-400 font-bold lg:text-sm sm: text-[9px]">Salário do mês</h6>
                                    </div>
                                </div>
                            </div>
                            <div className="absolute top-4 right-4 bg-indigo-400 text-white rounded-full lg:w-[40px] lg:h-[40px] flex items-center justify-center cursor-pointer sm: w-[20px] h-[20px]">
